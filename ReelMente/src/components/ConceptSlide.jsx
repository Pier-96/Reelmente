export default function ConceptSlide({ content }) {
  return (
    <div className="w-full max-w-3xl p-6 md:p-10 rounded-3xl bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 shadow-2xl">
