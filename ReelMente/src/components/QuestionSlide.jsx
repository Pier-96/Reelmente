export default function QuestionSlide({ content }) {
  return (
    <div className="w-full max-w-3xl p-6 md:p-10 rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-600 shadow-2xl">
