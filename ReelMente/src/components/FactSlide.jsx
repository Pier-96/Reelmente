export default function FactSlide({ content }) {
  return (
    <div className="w-full max-w-3xl p-6 md:p-10 rounded-3xl bg-gradient-to-br from-amber-500 via-orange-500 to-yellow-500 shadow-2xl">
