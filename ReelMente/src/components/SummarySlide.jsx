export default function SummarySlide({ content }) {
  return (
    <div className="w-full max-w-3xl p-6 md:p-10 rounded-3xl bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 shadow-2xl">
